        ...
        self.log_categories = {
            "agents": {
                ...
                "subcategories": {
                    ...
                    "navigation_agents": ["json_navigation_agent.log", "graph_navigation_agent.log", "integrated_navigation_agent.log"],
                    "documentation_agents": ["documentation_agent.log", "documentation_completer.log"],
                    "module_agents": ["module_creator.log", "module_generator.log", "module_analyzer.log", "module_tester.log"],
