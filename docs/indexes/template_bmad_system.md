---
tags: [template, bmad_system, automatic_links, wiki_navigation]
type: template
...
# 📋 **Template de Links - BMAD_System**

> [!info] **Template Automático**
> Este arquivo é um template para links automáticos da categoria **BMAD_System**
> 
> **Descrição**: Sistema de agentes inteligentes BMAD
...
### **🔗 Links da Categoria BMAD_System**
...
> para garantir que todos os arquivos da categoria BMAD_System
