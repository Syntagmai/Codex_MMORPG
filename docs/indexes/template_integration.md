---
tags: [template, integration, automatic_links, wiki_navigation]
type: template
...
# 📋 **Template de Links - Integration**

> [!info] **Template Automático**
> Este arquivo é um template para links automáticos da categoria **Integration**
> 
> **Descrição**: Sistema de integração OTClient-Canary
...
### **🔗 Links da Categoria Integration**
...
> para garantir que todos os arquivos da categoria Integration
