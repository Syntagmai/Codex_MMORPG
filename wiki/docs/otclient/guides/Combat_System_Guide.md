---
tags: [otclient, combat, battle, damage, system, guide, documentation, game-state-sync, canary, integration]
status: completed
aliases: [Sistema de Combate, Combat System, Battle System, Damage System]
...
> [!info] Este guia documenta o sistema completo de combate do OTClient, incluindo cálculos de dano, tipos de ataque, defesa, efeitos visuais e integração com o sistema de criaturas e itens.
