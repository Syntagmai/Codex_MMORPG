---
tags: [template, documentation, automatic_links, wiki_navigation]
type: template
...
# 📋 **Template de Links - Documentation**

> [!info] **Template Automático**
> Este arquivo é um template para links automáticos da categoria **Documentation**
> 
> **Descrição**: Documentação geral e referências
...
### **🔗 Links da Categoria Documentation**
...
> para garantir que todos os arquivos da categoria Documentation
