...
<div class="info"> O Sistema de Tabs e Abas do OTClient oferece funcionalidades avançadas para organizar conteúdo em abas, permitindo navegação eficiente entre diferentes seções da interface.
...
> - [UI_Scroll_Pagination_System_Guide](UI_Scroll_Pagination_System_Guide.md) - Sistema de scroll e paginação
> 
> **🔗 Navegação Rápida:**
