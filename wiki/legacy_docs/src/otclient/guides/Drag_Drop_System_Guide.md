...
<div class="info"> Este guia documenta o sistema completo de drag and drop do OTClient, incluindo arrastar widgets, drop zones, feedback visual e integração com o sistema de inventário e containers.

## 📋 Índice
- [#Visão Geral](#Visão Geral.md)
- [#Sistema de Drag](#Sistema de Drag.md)
- [#Sistema de Drop](#Sistema de Drop.md)
- [#Drop Zones](#Drop Zones.md)
- [#Feedback Visual](#Feedback Visual.md)
- [#Integração com Inventário](#Integração com Inventário.md)
- [#Integração com Containers](#Integração com Containers.md)
- [#Drag Customizado](#Drag Customizado.md)
