...
if __name__ == "__main__":
    ...
    if result:
        print(f"✅ Script map_updater.py executado com sucesso via módulo maps.map_updater")
    else:
        print(f"❌ Erro na execução do script map_updater.py via módulo maps.map_updater")
