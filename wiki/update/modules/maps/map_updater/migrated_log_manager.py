...
if __name__ == "__main__":
    ...
    if result:
        print(f"✅ Script log_manager.py executado com sucesso via módulo maps.map_updater")
    else:
        print(f"❌ Erro na execução do script log_manager.py via módulo maps.map_updater")
