...
if __name__ == "__main__":
    ...
    if result:
        print(f"✅ Script analyzer.py executado com sucesso via módulo agents.agent_orchestrator")
    else:
        print(f"❌ Erro na execução do script analyzer.py via módulo agents.agent_orchestrator")
