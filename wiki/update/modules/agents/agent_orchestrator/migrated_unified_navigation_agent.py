...
"""
Script Migrado: unified_navigation_agent.py
...
# -*- coding: utf-8 -*-
"""
Agente unificado de navegação (JSON + Grafos + Integração)
====================================
...
Data de consolidação: 2025-08-01 10:38:27
...
from graph_navigation_agent import GraphNavigationAgent
from json_navigation_agent import JSONNavigationAgent
...
if __name__ == "__main__":
    ...
    if result:
        print(f"✅ Script unified_navigation_agent.py executado com sucesso via módulo agents.agent_orchestrator")
    else:
        print(f"❌ Erro na execução do script unified_navigation_agent.py via módulo agents.agent_orchestrator")
...
### **📈 Métricas do Script**
- **Nome**: migrated_unified_navigation_agent
