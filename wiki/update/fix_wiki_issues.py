...
> [!info] **Bem-vindo à Wiki do OTClient!** Este é o ponto de entrada para toda a documentação do sistema, organizada de forma lógica e intuitiva para facilitar sua navegação.
...
> Esta wiki agora contém toda a informação disponível do projeto, integrando conteúdo do habdel e expandindo para cobrir todos os aspectos do OTClient. Todos os links estão funcionais e a navegação foi otimizada para facilitar o uso.
