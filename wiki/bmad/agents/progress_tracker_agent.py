...
|---------|-------------|------|--------|
| **Progresso Geral** | {current_metrics['progresso_geral']}% | 100% | {'🟢' if current_metrics['progresso_geral'] >= 80 else '🟡' if current_metrics['progresso_geral'] >= 50 else '🔴'} |
| **Epics** | {current_metrics['epics']}% | 100% | {'🟢' if current_metrics['epics'] >= 80 else '🟡' if current_metrics['epics'] >= 50 else '🔴'} |
| **Stories** | {current_metrics['stories']}% | 100% | {'🟢' if current_metrics['stories'] >= 80 else '🟡' if current_metrics['stories'] >= 50 else '🔴'} |
| **Agentes** | {current_metrics['agentes']}% | 100% | {'🟢' if current_metrics['agentes'] >= 80 else '🟡' if current_metrics['agentes'] >= 50 else '🔴'} |
| **Tasks** | {current_metrics['tasks']}% | 100% | {'🟢' if current_metrics['tasks'] >= 80 else '🟡' if current_metrics['tasks'] >= 50 else '🔴'} |
